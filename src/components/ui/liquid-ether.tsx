...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      _onMouseMove: ((e: MouseEvent) => void) | null = null;
      _onTouchStart: ((e: TouchEvent) => void) | null = null;
      _onTouchMove: ((e: TouchEvent) => void) | null = null;
    ...
    class ShaderPass {
      props: { material?: THREE.ShaderMaterialParameters; output?: THREE.WebGLRenderTarget | null };
      ...
      constructor(props: { material?: THREE.ShaderMaterialParameters; output?: THREE.WebGLRenderTarget | null }) {
        this.props = props || {};
    ...
    class Simulation {
      ...
      constructor(options: Record<string, unknown> = {}) {
        this.options = {
          ...
          isViscous: false,
          BFECC: true,
          ...(options as Partial<typeof this.options>),
        };
        ...
        for (const key of ['vel_0', 'vel_1', 'vel_viscous0', 'vel_viscous1', 'div', 'pressure_0', 'pressure_1']) {
          this.fbos[key] = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, fboOpts);
        }
    ...
    class WebGLManager {
      ...
      constructor(props: Record<string, unknown>) {
        this.props = props;
        Common.init(props.$wrapper as HTMLDivElement);
        Mouse.init(props.$wrapper as HTMLDivElement);
      ...
      init() {
        if (Common.renderer) {
          (this.props.$wrapper as HTMLDivElement).prepend(Common.renderer.domElement);
        }
